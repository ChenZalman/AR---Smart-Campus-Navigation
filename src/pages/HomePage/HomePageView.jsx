      ...
      <div className="w-full">
        <div>
          ...
          <div className="relative mt-[-80px] h-[560px]">
            ...
            <div className="absolute bottom-0 left-0 right-0 top-0 mx-auto mt-20 h-[440px] w-[75%] rounded-[40px] bg-royalblue-100 border-2 border-royalblue-300 shadow-lg" />
            ...
            <div className="absolute right-[16%] top-[25%] m-auto flex rounded-[112px] bg-bubble_gray-light px-4 pr-[100px] shadow-md md:py-5 p-4">
              <Text
                as="p"
                className="text-shadow-md mb-6 p-6 font-manrope text-[28px] font-bold text-royalblue-700 md:text-[24px] sm:text-[22px]"
              >
                <>
                  Hi I&#39;m Joe, <br />
