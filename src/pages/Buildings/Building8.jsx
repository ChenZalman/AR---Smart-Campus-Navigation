...
function Building8() {
  return (
    <div className="building-container max-w-7xl mx-auto px-4 py-12 bg-gray-50">
      <h1 className="text-4xl md:text-5xl font-bold text-teal-700 mb-8 text-center">בניין 8 - רוטשילד</h1>
      ...
      <div className="flex flex-col lg:flex-row items-start gap-10">
        ...
        <div className="w-full lg:w-1/2 order-1 lg:order-2">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-teal-100">
            ...
            >
              {[
                { floor: "קומת קרקע", items: ["המחלקה לטכנולוגיות דיגיטליות ברפואה", "מעבדת רובוטיקה"] },
                { floor: "קומה 4", items: ["הפקלוטה למדעים", "בית הספר למדעי המחשב", "בית הספר למדעי המתמטיקה",
                    "אודיטוריום"
                ] },
