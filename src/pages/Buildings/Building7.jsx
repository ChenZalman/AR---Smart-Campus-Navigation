...
function Building7() {
  return (
    <div className="building-container max-w-7xl mx-auto px-4 py-12 bg-gray-50">
      <h1 className="text-4xl md:text-5xl font-bold text-teal-700 mb-8 text-center">בניין 7 - פרץ</h1>
      ...
      <div className="flex flex-col lg:flex-row items-start gap-10">
        ...
        <div className="w-full lg:w-1/2 order-1 lg:order-2">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-teal-100">
            ...
            >
              {[
                { floor: "קומה 1-", items: ["חנות חומרים"] },
                { floor: "קומת קרקע", items: ["סדנה קלה", "סדנה כבדה","הפקלוטה לעיצוב"] },
                { floor: "קומת 2", items: ["מרחב ללימוד עצמי", "הדפסות",] },
