...
export default function PopPage() {
  ...
  useEffect(() => {
    dispatch({type: 0, payload:{discription: "ברוכים הבאים למכון טכנולוגי חולון. לחצו על הכפתור שמעליי בכדי להציג את המפה ולהתחיל את הסיור הוירטואלי, או שניתן גם לבצע סריקה באמצעות הכפתור העליון ולעבור מהר לדף הבניין המבוקש."}})
}, [])
