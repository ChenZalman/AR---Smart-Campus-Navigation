      ...
      <div className="mt-7 flex flex-col gap-28 md:gap-[84px] sm:gap-14">
            ...
            <div className="container-xs md:px-5">
              <div>
                <div className="flex flex-col items-center">
                  <Heading as="h1" className="font-titanone text-[64px] font-normal text-teal-700 md:text-[48px]">
        ...
        <TabList className="flex gap-[42px] rounded-[30px] bg-teal-700 px-9 py-3.5 sm:px-5">
          <Tab className="flex flex-wrap">
            ...
            <div className="ml-[42px] p-9 text-[14px] font-medium tracking-[0.10px] text-teal-700 sm:p-5">SIGN UP</div>
